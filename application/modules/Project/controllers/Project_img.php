...
class Project_img extends Private_Controller {
	...
	public function index()
	{
		...
		$this->render("Project","project_img_view", $data, true, true, true, $js, $css, $plugin_js, $plugin_css, "", "hold-transition skin-blue sidebar-mini", "wrapper");
	}

	public function grid($grid)
	{
		$this->load->model("Project_img_model");
		echo json_encode($this->Project_img_model->call_method($grid,"grid"));
	}

	public function ajax($action)
	{
		$this->load->model("Project_img_model");
		echo json_encode($this->Project_img_model->call_method($action,"action"));
	}
