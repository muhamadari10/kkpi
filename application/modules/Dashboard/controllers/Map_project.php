...
class Map_project extends Private_Controller {
	...
	public function index()
	{
		...
		$this->render("Dashboard","map_project_view", $data, true, true, true, $js, $css, $plugin_js, $plugin_css, "hold-transition skin-blue sidebar-mini", "wrapper");
	}	

	public function grid($grid)
	{
		$this->load->model("Map_project_model");
		echo json_encode($this->Map_project_model->call_method($grid,"grid"));
	}

	public function ajax($action)
	{
		$this->load->model("Map_project_model");
		echo json_encode($this->Map_project_model->call_method($action,"action"));
	}
