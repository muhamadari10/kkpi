...
class Unit extends Private_Controller {
	...
	public function index()
	{
		...
		$this->render("Administration","unit_view", $data, true, true, true, $js, $css, $plugin_js, $plugin_css, "", "hold-transition skin-blue sidebar-mini", "wrapper");
	}

	public function grid($grid)
	{
		$this->load->model("Unit_model");
		echo json_encode($this->Unit_model->call_method($grid,"grid"));
	}

	public function ajax($action)
	{
		$this->load->model("Unit_model");
		echo json_encode($this->Unit_model->call_method($action,"action"));
	}
