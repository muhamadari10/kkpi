...
class Dashboard extends Private_Controller {
	...
	public function index()
	{
		...
		$data = array();
		$this->render("Dashboard","dashboard_view", $data, true, true, true, $js, $css, $plugin_js, $plugin_css, "hold-transition skin-blue sidebar-mini", "wrapper");
	}

	public function grid($grid)
	{
		$this->load->model("Dashboard_model");
		echo json_encode($this->Dashboard_model->call_method($grid,"grid"));
	}

	public function ajax($action)
	{
		$this->load->model("Dashboard_model");
		echo json_encode($this->Dashboard_model->call_method($action,"action"));
	}
